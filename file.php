...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.bootcdn.net/ajax/libs/highlight.js/10.3.0/styles/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css">
    <?php endif;?>
    <style>
...
<?php if (FM_USE_HIGHLIGHTJS): ?>
    <script src="https://cdn.bootcdn.net/ajax/libs/highlight.js/10.3.0/highlight.min.js"></script>
...
function lng($txt)
{
    ...
    $tr['zh-CN']['Full size']                                        = '所有大小';
    $tr['zh-CN']['Help']                                             = '帮助';
    $tr['zh-CN']['Free of']                                          = 'Free of';
    $tr['zh-CN']['Preview']                                          = '预览';
    ...
    $tr['zh-CN']['ProcessID']                                        = 'Process ID';
    $tr['zh-CN']['Created']                                          = '已建立';
    ...
    $tr['zh-CN']['password_hash not supported, Upgrade PHP version'] = 'password_hash不支持，升级PHP版本';
    if (!strlen($lang)) {
        $lang = 'zh-CN';
    }
    if (isset($tr[$lang][$txt])) {
        return fm_enc($tr[$lang][$txt]);
    } else if (isset($tr['zh-CN'][$txt])) {
        return fm_enc($tr['zh-CN'][$txt]);
    } else {
        return "$txt";
    }
}
